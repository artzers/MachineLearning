...
output ='The joke'#revert_vocab[np.random.randint(4, len(vocab)-1)]
random_sample = False#True
new_sentence = True
...
#         new_sentence = False
#     if i <= ignore_length - 1:
#         MakeInput(cache[i], vocab, input_ndarray)
#     else:
#         MakeInput(cache[-1], vocab, input_ndarray)
#     prob = model.forward(input_ndarray, new_sentence)
#     next_char = MakeOutput(prob, revert_vocab, random_sample)
#     while next_char == '':
#         new_sentence = True
